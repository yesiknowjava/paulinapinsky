;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="ccc84fa85b25b19580fa9cb7fdb2b20a";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["QbU9UoX9Sb9s"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["QbU9UoX9Sb9s"].options={"account":{"accountId":"o189N7Hs5hGu","service":"googleanalytics","userId":"107659686748277260703"},"anonymizeIp":false,"id":"UA-104692314-1","social":false};;if(CloudflareApps.matchPage(CloudflareApps.installs['QbU9UoX9Sb9s'].URLPatterns)){(function(){var options=CloudflareApps.installs['QbU9UoX9Sb9s'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("QbU9UoX9Sb9s"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
